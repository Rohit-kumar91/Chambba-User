...
static const CGFloat kDefaultHeight = 100.0;
...
//        self.font = btn.titleLabel.font;
    ...
    {
        self.textColor = [UIColor grayColor];
        self.font = [UIFont systemFontOfSize:5.0];
...
-(void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.textColor = [UIColor colorWithRed:85/255 green:85/255 blue:85/255 alpha:1];
