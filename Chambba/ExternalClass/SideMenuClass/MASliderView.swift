...
open class MASliderView: UIView {
    ...
    let kMACenterViewContainerCornerRadius: CGFloat = 0.0//5.0
    let kMADefaultViewContainerWidth: CGFloat = 280.0
    ...
    fileprivate var leftViewWidthConstraint: NSLayoutConstraint {
        get {
            ...
            let retVal = NSLayoutConstraint(item: self.leftViewContainer, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute,  multiplier: 1.0, constant: self.kMADefaultViewContainerWidth)
    ...
    fileprivate var rightViewWidthConstraint: NSLayoutConstraint {
        get {
            ...
            let constraint = NSLayoutConstraint(item: self.rightViewContainer, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute,  multiplier: 1.0, constant: self.kMADefaultViewContainerWidth)
    ...
    var shouldRadiusCenterViewController: Bool {
        ...
        set {
            ...
            if (newValue) {
                ...
                view?.layer.cornerRadius  = kMACenterViewContainerCornerRadius
            } else {
    ...
    func updateShadowPath() {
        ...
        layer.shadowPath = UIBezierPath(roundedRect: rect, cornerRadius: kMACenterViewContainerCornerRadius).cgPath
    }
    
    func viewContainerForSliderSide(_ sliderSide: MASliderSide) -> UIView? {
    ...
    func willOpenSlider(_ viewController: MASliderViewController) {
        self.shouldRadiusCenterViewController = true
        self.shouldShadowCenterViewContainer = true
        
        // additional line added for special case of status bar in this app (MobileApp)
        UIApplication.shared.statusBarStyle = .lightContent
    }
    
    func willCloseSlider(_ viewController: MASliderViewController) {
